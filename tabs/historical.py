...
def render(thresh, highlight_color):
    ...
    if not df.empty:
        ...
        # Display dataframe with pagination and highlight
        ...
        if chart_type == "Line":
            chart = px.line(df, x="timestamp", y="dos_rate", color="label", color_discrete_map={"Normal": "blue", "Attack": "red"})
        elif chart_type == "Bar":
            chart = px.bar(df, x="timestamp", y="dos_rate", color="label", color_discrete_map={"Normal": "blue", "Attack": "red"})
        elif chart_type == "Pie":
            chart = px.pie(df, names="label")
        elif chart_type == "Area":
            chart = px.area(df, x="timestamp", y="dos_rate", color="label", color_discrete_map={"Normal": "blue", "Attack": "red"})
        elif chart_type == "Scatter":
            chart = px.scatter(df, x="timestamp", y="dos_rate", color="label", color_discrete_map={"Normal": "blue", "Attack": "red"})
