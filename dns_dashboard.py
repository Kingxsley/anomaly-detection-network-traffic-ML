...
def render_overview(time_range, sqlite_host, sqlite_port, sqlite_db, sqlite_apikey):
    ...
    df = get_historical_data_for_dos(time_range, sqlite_host, sqlite_port, sqlite_db, sqlite_apikey)  # Modify for DNS data
    
    if not df.empty:
        # Display metrics and summary for the DNS data
